...
import {
  eagerEvaluateLazyInit,
  removeSideEffectLoadShareImports,
  resolveProxyAlias,
  ...
  return [
    ...
    }),
    {
      ...
      generateBundle(_, bundle) {
        ...
        // Pass 0a (rolldown): strip circular side-effect imports of loadShare chunks
        removeSideEffectLoadShareImports(bundle as any, LOAD_SHARE_TAG);

        // Pass 0b (rolldown): convert lazy-init wrappers to eager TLA evaluation
        eagerEvaluateLazyInit(bundle as any, LOAD_SHARE_TAG);
