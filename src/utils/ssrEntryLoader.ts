...
async function fetchEsmToTempFile(
  ...
  const promise = (async () => {
    ...
    // and for the zero-whitespace `import"./x.js"` side-effect form that
    // minified Vite/Rolldown output commonly emits — mirror transformSsrCode's
    // rewrite pattern above so discovery and rewriting agree on what counts
